package team34.tarot.dto.gptdto.response;
...
public class CompletionChatResponse {
	...
	public static List<CompletionChatResponse.Message> toResponseListBy(List<ChatCompletionChoice> choiceList) {
		return choiceList.stream()
						.map(choice -> Message.of(choice.getMessage()))
